...
void prog(){
   ...
   flash_to_ram();
    ...
    REG(IO_BANK0_BASE + IO_BANK0_GPIO23_CTRL_OFFSET) = GPIO_FUNC_PIO0;
    ...
    REG(PIO0_BASE + PIO_SM0_PINCTRL_OFFSET + REG_ALIAS_SET_BITS) = 23<<PIO_SM0_PINCTRL_SET_BASE_LSB | 1<<PIO_SM0_PINCTRL_SET_COUNT_LSB;
