...
A processor can determine its identity (0 or 1) by reading the CPUID register ([rp2040] section 2.3.1.7). Hence we can run the same function (blink) on both cores and have the processor determine the pin and blink frequency
to use.
